...
const mongoURI = process.env.mongoURI + "case"; //URI for connecting to database specified in .env
...
const whitelist = ["http://localhost:3003/", "https://sad-spence.netlify.app/", "http://example2.com"];
const corsOptions = {
